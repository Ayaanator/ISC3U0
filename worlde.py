    ...
    while True:
        ...
        while guess_counter < MAX_GUESSES and playing:
            ...
            if guess == secret:
                ...
                print("Green means it is the correct letter at the correct spot.")
                print("Red means it is the correct letter at the wrong spot.")
        ...
        print(f"Wins per loss: {wins / games}")
